      ...
      <div class="l-inner">
        ...
        <form method="POST" action="{{ route('login') }}">
          ...
          <div class="form-group ac-bx d-flex align-items-sm-center justify-content-between">
					...
					<a href="{{ route('password.request') }}" class="lnkForgot">Forgot Password?</a>
				</div>
        <div class="submit-btn">
					<input type="submit" value="Submit" />
				</div>
        <div><a href="{{ route('google') }}"><i class="mdi mdi-google"></i></a></div>
          <p class="p-reg">Don't have an account? <a href="{{route('register')}}">Register here</a>, it takes less than a minute.</p>
      </form>
      </div>
    </div>
    </div>
