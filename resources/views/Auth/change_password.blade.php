<!DOCTYPE html>
  ...
  <section class="sec-login">
    <div class="container">
      ...
      <form class="forms-sample change_password_from" method="POST" action="{{route('changePassword.store')}}">
        @csrf 
          <div class="mb-3">
            <label for="old_password" class="form-label">Old Passowrd</label>
          ...
          <div class="mb-3">
            ...
            <input type="password" class="form-control" name='new_password' id="new_password" autocomplete="new_password" placeholder="Enter New Password">
            <div class="text-danger">
                @error('new_password')
                  {{$message}}
                @enderror
          ...
          <div class="mb-3">
              ...
              <input type="password" class="form-control" name='confirm_new_password' id="confirm_new_password" autocomplete="confirm_new_password" placeholder="Enter Confirm New Password">
              <div class="text-danger">
          ...
          <div>
            ...
            <button type="submit" class="btn btn-primary me-2 mb-2 mb-md-0">Change Password</button>
          </div>
      </form>
