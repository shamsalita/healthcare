        ...
        <div class="header-inner flex">
            ...
            <div class="header-right">
                ...
                <ul class="nav-list">
                    ...
                    @else
                    <li><a href="{{route('welcome')}}">{{auth()->user()->user_status==0  ?'I am Doctor':'I am Hospital'}} </a></li>
                    @endif
                    ...
                    <li class="sign-in-btn"><a href="{{route('register')}}">Get Started</a></li>
                    @elseif(auth()->user())
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('chat') }}" id="" role="button" aria-expanded="false">
                            <i class="mdi mdi-message" ></i>
                            <span class="badge badge-danger" style="color: red;">{{ unreadchat_c() }}</span>
                        </a>
                    </li>
                    
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="wd-30 ht-30 rounded-circle" src="{{ auth()->user()->profile }}" alt="profile">
                        </a>
                        <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                            <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                            <div class="mb-3">
                                <img class="wd-80 ht-80 rounded-circle" src="{{ auth()->user()->profile }}" alt="">
                            </div>
                            ...
                            <li class="dropdown-item py-2">
                                <a href="{{ url('profile/'.auth()->user()->remember_token) }}" class="text-body ms-0">
