      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu p-0" aria-labelledby="appsDropdown">
          ...
          <div class="row g-0 p-1">
            ...
            <div class="col-3 text-center">
              <a href="{{ route('profile.dashboard') }}" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i data-feather="instagram" class="icon-lg mb-1"></i><p class="tx-12">Profile</p></a>
            </div>
          </div>
        ...
        <div class="dropdown-menu p-0" aria-labelledby="messageDropdown">
          ...
          <div class="p-1">
            <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
              <div class="me-3">
                <img class="wd-30 ht-30 rounded-circle" src="{{ url('https://via.placeholder.com/30x30') }}" alt="user">
              </div>
        ...
        <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
          ...
          <ul class="list-unstyled p-1">
            <li class="dropdown-item py-2">
              <a href="{{ route('profile.dashboard') }}" class="text-body ms-0">
