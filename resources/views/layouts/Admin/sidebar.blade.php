<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['export-to-pdf']) }}">
        <a href="{{ url('export-to-pdf') }}" class="nav-link">
          <i class="link-icon" data-feather="file"></i>
          {{-- <i class="fa fa-file-pdf-o" aria-hidden="true"></i> --}}
          <span class="link-title">Export to PDF</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['export-to-doc']) }}">
        <a href="{{ url('export-to-doc') }}" class="nav-link">
          <i class="link-icon" data-feather="file-text"></i>
          <span class="link-title">Export to Doc</span>
        </a>
      </li>
