...
<meta charset="utf-8" />
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="includes/pages/images/favicon-32x32.png">
...
<body>
<header class="header-cstm">
    <div class="container">
        <div class="header-inner">
            <div class="logo"><a href="#"><svg width="240" height="49" viewBox="0 0 240 49" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="nav-right">
                <div class="logout-a"><a href="logout.php">Logout</a></div>
            </div>
        </div>
    </div>
</header>
...
<section class="fd-cstm">
    <div class="container">
    <div class=col-md-12>
    <form method="POST" action="exprt_to_doc.php">
